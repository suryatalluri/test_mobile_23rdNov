...
import com.test_mobile_23rdnov.test_23rdnov.service.Table1Service;
 ...
 * @see com.test_mobile_23rdnov.test_23rdnov.Table1
 */
@RestController(value = "Test_23rdNov.Table1Controller")
@RequestMapping("/Test_23rdNov/Table1")
...
public class Table1Controller {
    ...
    @Autowired
    @Qualifier("Test_23rdNov.Table1Service")
    ...
    public Table1 getTable1(@RequestParam("column2") String column2, @RequestParam("column3") String column3, @RequestParam("id") Integer id) throws EntityNotFoundException {
        Table1Id temp = new Table1Id();
        temp.setColumn2(column2);
        temp.setColumn3(column3);
        temp.setId(id);
    ...
    public boolean deleteTable1(@RequestParam("column2") String column2, @RequestParam("column3") String column3, @RequestParam("id") Integer id) throws EntityNotFoundException {
        Table1Id temp = new Table1Id();
        temp.setColumn2(column2);
        temp.setColumn3(column3);
        temp.setId(id);
    ...
    public Table1 editTable1(@RequestParam("column2") String column2, @RequestParam("column3") String column3, @RequestParam("id") Integer id, @RequestBody Table1 instance) throws EntityNotFoundException {
        Table1Id temp = new Table1Id();
        temp.setColumn2(column2);
        temp.setColumn3(column3);
        temp.setId(id);
