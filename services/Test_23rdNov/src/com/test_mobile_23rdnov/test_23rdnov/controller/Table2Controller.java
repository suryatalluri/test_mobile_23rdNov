...
import com.test_mobile_23rdnov.test_23rdnov.service.Table2Service;
 ...
 * @see com.test_mobile_23rdnov.test_23rdnov.Table2
 */
@RestController(value = "Test_23rdNov.Table2Controller")
@RequestMapping("/Test_23rdNov/Table2")
...
public class Table2Controller {
    ...
    @Autowired
    @Qualifier("Test_23rdNov.Table2Service")
