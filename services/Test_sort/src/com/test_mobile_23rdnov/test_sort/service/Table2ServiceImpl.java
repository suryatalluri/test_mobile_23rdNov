 ...
 */
@Service("Test_sort.Table2Service")
public class Table2ServiceImpl implements Table2Service {
    ...
    public void setWMGenericDao(WMGenericDao<Table2, Table2Id> wmGenericDao){
     ...
     @Transactional(readOnly = true, value = "Test_sortTransactionManager")
    ...
    @Transactional(rollbackFor = EntityNotFoundException.class, value = "Test_sortTransactionManager")
    @Override
