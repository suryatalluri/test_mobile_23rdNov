...
@Service
public class Test_sortQueryExecutorServiceImpl implements Test_sortQueryExecutorService {
	private static final Logger LOGGER = LoggerFactory.getLogger(Test_sortQueryExecutorServiceImpl.class);

	@Autowired
	@Qualifier("Test_sortWMQueryExecutor")
