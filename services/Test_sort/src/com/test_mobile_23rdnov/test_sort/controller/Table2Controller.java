...
import com.test_mobile_23rdnov.test_sort.service.Table2Service;
 ...
 * @see com.test_mobile_23rdnov.test_sort.Table2
 */
@RestController(value = "Test_sort.Table2Controller")
@RequestMapping("/Test_sort/Table2")
...
public class Table2Controller {
    ...
    @Autowired
    @Qualifier("Test_sort.Table2Service")
